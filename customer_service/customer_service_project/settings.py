...
SECRET_KEY = os.getenv("SECRET_KEY", "customer-service-secret")
...
ROOT_URLCONF = 'customer_service_project.urls'
...
WSGI_APPLICATION = 'customer_service_project.wsgi.application'
